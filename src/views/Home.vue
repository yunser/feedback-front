<template>
    <my-page :title="pageTitle" :page="page">
        <div class="common-container container">
            ...
            <div>
                <div>当然，你也可以联系 QQ 1418503647 或 邮箱 <a href="mailto:admin@yunser.com">admin@yunser.com</a> 进行反馈。</div>
                    ...
                    menu: [
                        {
                            type: 'icon',
                            icon: 'apps',
                            href: 'https://app.yunser.com?utm_source=about',
                            target: '_blank',
                            title: '应用'
                        }
                    ]
